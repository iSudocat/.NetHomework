            ...
            switch (op)
            {
                case "ID":
                    var olist = from o in OrderList
                                ...
                                select o;
                    var l = olist.ToList();
                    l.Sort((o1, o2) => o1.TotalPrice.CompareTo(o2.TotalPrice));
                ...
                case "Product":
                    var olist1 = from o in OrderList
                                 where o.HasGood(src)
                                 select o;
                    var l1 = olist1.ToList();
                    l1.Sort((o1, o2) => o1.TotalPrice.CompareTo(o2.TotalPrice));
                    foreach (var o in l1)
                    {
                        re = re + o.ToString() + "\n";
                    }
                ...
                case "Customer":
                    var olist2 = from o in OrderList
                                 ...
                                 select o;
                    var l2 = olist2.ToList();
                    l2.Sort((o1, o2) => o1.TotalPrice.CompareTo(o2.TotalPrice));
                    foreach (var o in l2)
                    {
                        re = re + o.ToString() + "\n";
                    }
